...
const ICONS: Record<IconName, IconShape> = {
  ...
  // 隐私盾牌（同意记录）
  shield: { paths: ['M12 3.4 5 6v5.4c0 4.4 3 7.6 7 9.2 4-1.6 7-4.8 7-9.2V6z'] },
  // 下载（导出数据）
  download: { paths: ['M12 3.6v11.6', 'M7.6 10.8 12 15.2l4.4-4.4', 'M4.8 20.4h14.4'] },
  // 删除（垃圾桶）
  trash: {
    paths: [
      'M5.6 7.2h12.8',
      'M8.4 7.2V5.4a1.4 1.4 0 0 1 1.4-1.4h4.4a1.4 1.4 0 0 1 1.4 1.4v1.8',
      'M7.2 7.2l.8 11.2a1.4 1.4 0 0 0 1.4 1.4h5.2a1.4 1.4 0 0 0 1.4-1.4l.8-11.2',
    ],
  },
  // 设置（齿轮）
  gear: {
    paths: [
      ...
      'M19.4 12c0-.5-.1-1-.2-1.4l2-1.5-2-3.4-2.3 1a7.6 7.6 0 0 0-2.4-1.4L14.1 2.6H9.9l-.4 2.7c-.9.3-1.7.8-2.4 1.4l-2.3-1-2 3.4 2 1.5c-.1.4-.2.9-.2 1.4s.1 1 .2 1.4l-2 1.5 2 3.4 2.3-1c.7.6 1.5 1.1 2.4 1.4l.4 2.7h4.2l.4-2.7c.9-.3 1.7-.8 2.4-1.4l2.3 1 2-3.4-2-1.5c.1-.4.2-.9.2-1.4z',
    ],
  },
  // 退出登录
  logout: { paths: ['M14.4 4.8H7.2a1.6 1.6 0 0 0-1.6 1.6v11.2a1.6 1.6 0 0 0 1.6 1.6h7.2', 'M15.6 8.4 19.2 12l-3.6 3.6', 'M19.2 12H9.6'] },
}
